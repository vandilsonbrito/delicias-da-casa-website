...
export default function Footer() {
  return (
    <div className="w-full h-full py-14 px-10 lg:px-28 flex flex-col items-center justify-center border-t-[1px] border-slate-200" >
        <img className='h-24' src={logoImg} alt="Logo da Padaria do Baiano" />

        <div className="w-full h-full flex flex-col lg:flex-row justify-start items-center lg:items-start lg:justify-evenly">
            <div className="w-fit h-full">
                <h4 className="text-lg lg:text-[2rem] text-center mt-16 mb-3 lg:mb-10">Localização</h4>
                <iframe 
            ...
            <div className="w-fit h-full flex flex-col items-center">
                <h4 className="text-lg lg:text-[2rem] text-center mt-16 mb-3 lg:mb-10 ">Contato</h4>
                <p className='text-sm lg:text-xl'>(11)987492514</p>
            </div>
        </div>
    </div>
  )
